...
\subsection{Definición de parámetros de valoración}
...
Dado que los posibles valores a introducir en esta ventana vienen predefinidos, no hay posibilidad de que el usuario introduzca datos erróneos en cada opinión. 

\subsection{Vista de resultados}
Una vez tenemos los suficientes datos para computar el valor de una empresa por cualquiera de los dos métodos, en la pestaña de resultados se ofrecerán de forma comparativa los resultados obtenidos con todos los métodos computables con los datos de entrada.

La mejor manera de mostrar estos datos se decidirá durante la fase de implementación, siendo preferible una visualización gráfica si es técnicamente factible. 

\section{Casos de uso}
A partir de la descripción funcional, podemos extraer los casos de uso del sistema y las relaciones entre estos. 

Hay tres casos de uso principales:
\begin{itemize}
	\item Valorar una empresa utilizando el método del Cashflow con información lingüística.
	\item Valorar una empresa utilizando el método del análisis mixto con información lingüística.
	\item Definir una jerarquía lingüística.
\end{itemize}  

Estos casos de uso contienen casos de uso específicos como son el definir niveles o etiquetas, y el definir datos de entrada y expertizajes. 
...
A continuación, describiremos formalmente estos casos de uso. 
