...
Para alcanzar un consenso sobre la validez de dicha información, se pide a diez expertos que den su opinion, usando distintos conjuntos de etiquetas semánticas. Tomando como conjunto de referencia el conjunto $S_{9}$, obtenemos las opiniones reflejadas en la tabla \ref{tab:OpinionExpertones}
\begin{table}[!htb]
	\centering
		\begin{tabular}{c c}
			\toprule
...
Finalmente obtenemos el intervalo ajustado, calculando la esperanza matemática del expertón. Esto es, sumando todos los valores del expertón en cada extremo del intervalo (excepto el nivel 0), y dividiendo entre el número de elementos.
